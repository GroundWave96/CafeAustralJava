...
INSERT INTO ADMINISTRADORES (Nome, Sobrenome, Genero, Email, Senha) VALUES
('admin', 'Sobrenome1', 'Masculino', 'admin1@example.com', 'admin'),
('Admin2', 'Sobrenome2', 'Feminino', 'admin2@example.com', 'password2'),
('Admin3', 'Sobrenome3', 'Masculino', 'admin3@example.com', 'password3'),
('Admin4', 'Sobrenome4', 'Feminino', 'admin4@example.com', 'password4'),
('Admin5', 'Sobrenome5', 'Masculino', 'admin5@example.com', 'password5'),
('Admin6', 'Sobrenome6', 'Feminino', 'admin6@example.com', 'password6'),
('Admin7', 'Sobrenome7', 'Masculino', 'admin7@example.com', 'password7'),
('Admin8', 'Sobrenome8', 'Feminino', 'admin8@example.com', 'password8'),
('Admin9', 'Sobrenome9', 'Masculino', 'admin9@example.com', 'password9'),
('Admin10', 'Sobrenome10', 'Feminino', 'admin10@example.com', 'password10');

INSERT INTO FORNECEDORES (Nome, CNPJ, Telefone, Email, Senha) VALUES
('Fornecedor1', '12345678901234567890', '1234567890', 'fornecedor1@example.com', 'password1'),
('Fornecedor2', '22345678901234567890', '2234567890', 'fornecedor2@example.com', 'password2'),
('Fornecedor3', '32345678901234567890', '3234567890', 'fornecedor3@example.com', 'password3'),
('Fornecedor4', '42345678901234567890', '4234567890', 'fornecedor4@example.com', 'password4'),
('Fornecedor5', '52345678901234567890', '5234567890', 'fornecedor5@example.com', 'password5'),
('Fornecedor6', '62345678901234567890', '6234567890', 'fornecedor6@example.com', 'password6'),
('Fornecedor7', '72345678901234567890', '7234567890', 'fornecedor7@example.com', 'password7'),
('Fornecedor8', '82345678901234567890', '8234567890', 'fornecedor8@example.com', 'password8'),
('Fornecedor9', '92345678901234567890', '9234567890', 'fornecedor9@example.com', 'password9'),
('Fornecedor10', '10345678901234567890', '1034567890', 'fornecedor10@example.com', 'password10');
